...
export function KeyMetricDonut({
  ...
  return (
    <div
      className="group/donut relative shrink-0 cursor-default"
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute left-1/2 top-full z-20 mt-2 w-[max-content] max-w-[14rem] -translate-x-1/2 rounded-lg border border-gray-200 bg-white px-2.5 py-2 text-left text-[11px] leading-snug text-gray-900 opacity-0 shadow-lg transition-opacity duration-150 group-hover/donut:opacity-100 motion-reduce:transition-none max-sm:hidden"
        role="tooltip"
      >
