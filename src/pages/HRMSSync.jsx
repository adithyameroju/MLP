...
import {
  ...
  User, Users, Shield, CheckCircle, RefreshCw,
} from 'lucide-react'
...
export default function HRMSSync() {
  ...
  return (
    <div className="flex flex-col h-full px-6 lg:px-8 py-3">
      <PageHeader
        title="HRMS Sync"
        subtitle="Review and approve employee changes synced from your HRMS"
        breadcrumbs={[endorsementsModuleCrumb, { label: 'HRMS Sync' }]}
      />
      ...
      <p className="mb-4 flex-shrink-0 text-xs text-gray-500">Filter the lists below using the search in the top bar.</p>
