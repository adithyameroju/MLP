    ...
    return (
      <div className="flex flex-col h-full min-h-0 px-6 lg:px-8 pt-4 pb-6">
        ...
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center rounded-2xl border border-amber-200/90 bg-gradient-to-b from-amber-50/90 to-white px-6 py-10 text-center shadow-sm">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Your CD balance is very low</h1>
          ...
          <p className="mt-8 text-[11px] text-gray-400 max-w-sm">
            Demo: change scenario with the dropdown in the header, or use <span className="font-medium text-gray-500">Endorsements</span> or <span className="font-medium text-gray-500">Add Employee</span> in the breadcrumbs to leave this flow.
          </p>
        </div>
      </div>
    )
